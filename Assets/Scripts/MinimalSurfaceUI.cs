...
public class MinimalSurfaceUI : MonoBehaviour {
    ...
    void OnGUI() {
        ...
        _cameraMovement.cameraDistance = DrawFloatSlider("Camera Distance", _cameraMovement.cameraDistance, _cameraMovement.minCameraDistance, _cameraMovement.maxCameraDistance);
